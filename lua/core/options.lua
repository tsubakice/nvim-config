...
-- 获取更好的缩进体验
vim.opt.autoindent = true -- 开辟新行时使用 “上一行” 的缩进方式
vim.opt.smartindent = true -- 用于处理类 C 编程语言的缩进, 一般也能满足其它编程语言的基本缩进要求
