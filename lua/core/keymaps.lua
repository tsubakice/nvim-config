...
vim.keymap.set('i', '<c-v>', '<cmd>echo "粘贴请使用 shift+insert"<cr>', opts)
...
-- 禁用上下左右键（可选）
vim.keymap.set('i', '<left>', '<cmd>echo \'使用 ctrl+h 移动光标哦\'<cr>', opts)
vim.keymap.set('i', '<down>', '<cmd>echo \'使用 ctrl+j 移动光标哦\'<cr>', opts)
vim.keymap.set('i', '<up>', '<cmd>echo \'使用 ctrl+k 移动光标哦\'<cr>', opts)
vim.keymap.set('i', '<right>', '<cmd>echo \'使用 ctrl+l 移动光标哦\'<cr>', opts)
vim.keymap.set({ 'n', 'v' }, '<left>', '<cmd>echo \'使用 h 移动光标哦\'<cr>', opts)
vim.keymap.set({ 'n', 'v' }, '<down>', '<cmd>echo \'使用 j 移动光标哦\'<cr>', opts)
vim.keymap.set({ 'n', 'v' }, '<up>', '<cmd>echo \'使用 k 移动光标哦\'<cr>', opts)
vim.keymap.set({ 'n', 'v' }, '<right>', '<cmd>echo \'使用 l 移动光标哦\'<cr>', opts)
